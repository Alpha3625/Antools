...
const initBurgerMenu = () => {
    ...
    //     let l = burgerMenu.classList.contains('active') && !e.target.classList.contains('burger-menu');
    //     if (l) {
    //         mobileMenuToggle(burgerMenu, nav, overlay);
    //     }
    // });
...
const initDropList = () => {
    ...
    observer.observe(dropList, { attributes: true });
