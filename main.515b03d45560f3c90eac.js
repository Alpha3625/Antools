...
function initCheckWindowSize(burgerMenu, nav, overlay, body) {
...
const initBurgerMenu = () => {
    ...
    if (burgerMenu && nav && overlay) {
        ...
        checkWindowSize(burgerMenu, nav, overlay, body);
    } else {
...
const initDropList = () => {
    ...
    //     if (header.classList.contains('active') && dropList.classList.contains('active')) {
...
const initSplide = new (splide_min_default())('.splide', {
  type: 'loop',
  perPage: 1,
  autoplay: true,
  interval: 10000
...
//         paragraphs.forEach(item => item.classList.add('active'));
//       }
//     });
// });

// observer.observe(document.querySelector('.popular-tools__cards'));
// });
